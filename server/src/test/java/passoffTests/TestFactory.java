...
public class TestFactory {
  ...
  public static ChessMove getNewMove(
  ...
  public static ChessPosition startPosition(int row, int col) {
    return getNewPosition(row, col);
  }

  public static int[][] endPositions(int[][] endPos) {
    return endPos;
  }

  public static void validateMoves(
      String boardText, ChessPosition startPosition, int[][] endPositions) {
  ...
  static final Map<Character, ChessPiece.PieceType> charToTypeMap =
      Map.of(
      ...
      switch (c) {
        ...
        default -> {
          ChessGame.TeamColor color =
              Character.isLowerCase(c) ? ChessGame.TeamColor.BLACK : ChessGame.TeamColor.WHITE;
  ...
  public static Set<ChessMove> loadMoves(ChessPosition startPosition, int[][] endPositions) {
    ...
    for (var endPosition : endPositions) {
      validMoves.add(
          TestFactory.getNewMove(
              startPosition, TestFactory.getNewPosition(endPosition[0], endPosition[1]), null));
    }
    return validMoves;
  }
}

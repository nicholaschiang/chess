...
public class StandardAPITests {
  ...
  public void successLogin() throws TestException {
    ...
    Assertions.assertNotNull(
        loginResult.authToken, "Response did not return authentication String");
  }
  ...
  public void loginInvalidUser() throws TestException {
    ...
    Assertions.assertNull(
        loginResult.authToken, "Response incorrectly return authentication String");
  }
  ...
  public void uniqueAuthorizationTokens() throws TestException {
    ...
    Assertions.assertEquals(
        ...
        "Server response code was not 200 OK");
    Assertions.assertFalse(
        logoutResult.message != null
            && logoutResult.message.toLowerCase(Locale.ROOT).contains("error"),
    ...
    TestModels.TestResult joinResult =
        serverFacade.verifyJoinPlayer(joinRequest, loginOne.authToken);
    Assertions.assertEquals(
        HttpURLConnection.HTTP_OK,
        serverFacade.getStatusCode(),
        "Server response code was not 200 OK");
  ...
  public void successRegister() throws TestException {
    ...
    Assertions.assertEquals(
        ...
        "Server response code was not 200 OK");
    Assertions.assertFalse(
        registerResult.message != null
            && registerResult.message.toLowerCase(Locale.ROOT).contains("error"),
        "Response gave an error message");
    Assertions.assertEquals(
        newUser.username,
    ...
    Assertions.assertNotNull(
        registerResult.authToken, "Response did not contain an authentication string");
  }
  ...
  public void registerTwice() throws TestException {
    ...
    Assertions.assertNull(
        registerResult.authToken, "Response incorrectly contained authentication string");
  }
  ...
  public void successLogout() throws TestException {
    ...
    Assertions.assertEquals(
        ...
        "Server response code was not 200 OK");
    Assertions.assertFalse(
        result.message != null && result.message.toLowerCase(Locale.ROOT).contains("error"),
        "Response gave an error message");
  }
  ...
  public void goodWatch() throws TestException {
    ...
    Assertions.assertEquals(
        ...
        "Server response code was not 200 OK");
    Assertions.assertEquals(
        1, listResult.games.length, "List Games returned an incorrect number of games");
    Assertions.assertNull(
        listResult.games[0].whiteUsername, "Player present on a game that no player joined");
    Assertions.assertNull(
        listResult.games[0].blackUsername, "Player present on a game that no player joined");
  }
  ...
  public void badAuthWatch() throws TestException {
    ...
    // try watch
    TestModels.TestResult watchResult =
        serverFacade.verifyJoinPlayer(watchRequest, existingAuth + "bad stuff");
  ...
  public void badAuthJoin() throws TestException {
    ...
    // try join
    TestModels.TestResult joinResult =
        serverFacade.verifyJoinPlayer(joinRequest, existingAuth + "bad stuff");
  ...
  public void noGamesList() throws TestException {
    ...
    Assertions.assertEquals(
        ...
        "Server response code was not 200 OK");
    Assertions.assertTrue(
        result.games == null || result.games.length == 0, "Found games when none should be there");
    Assertions.assertFalse(
        result.message != null && result.message.toLowerCase(Locale.ROOT).contains("error"),
        "Result returned an error message");
  }
  ...
  public void clearData() throws TestException {
    ...
    TestModels.TestCreateResult createResult =
        serverFacade.createGame(createRequest, registerResult.authToken);
    ...
    Assertions.assertEquals(
        ...
        "Server response code was not 200 OK");
    Assertions.assertEquals(
        0, listResult.games.length, "list result did not return 0 games after clear");
  }

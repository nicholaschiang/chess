...
public class ChessGameTests {
  ...
  public void invalidMoves() throws InvalidMoveException {
    ...
    Assertions.assertThrows(
        ...
        () -> game.makeMove(getNewMove(getNewPosition(2, 1), getNewPosition(5, 1), null)));
    ...
    Assertions.assertThrows(
        InvalidMoveException.class,
        () -> game.makeMove(getNewMove(getNewPosition(7, 2), getNewPosition(6, 3), null)));
    ...
    Assertions.assertThrows(
        InvalidMoveException.class,
        () -> game.makeMove(getNewMove(getNewPosition(1, 1), getNewPosition(4, 1), null)));
    ...
    Assertions.assertThrows(
        InvalidMoveException.class,
        () -> game.makeMove(getNewMove(getNewPosition(8, 7), getNewPosition(5, 5), null)));
    ...
    Assertions.assertThrows(
        InvalidMoveException.class,
        () -> game.makeMove(getNewMove(getNewPosition(1, 6), getNewPosition(2, 5), null)));
    ...
    Assertions.assertThrows(
        InvalidMoveException.class,
        () -> game.makeMove(getNewMove(getNewPosition(8, 4), getNewPosition(6, 4), null)));
    ...
    Assertions.assertThrows(
        InvalidMoveException.class,
        () -> game.makeMove(getNewMove(getNewPosition(4, 5), getNewPosition(5, 5), null)));
    ...
    Assertions.assertThrows(
        InvalidMoveException.class,
        () -> game.makeMove(getNewMove(getNewPosition(3, 4), getNewPosition(5, 6), null)));
    ...
    Assertions.assertThrows(
        InvalidMoveException.class,
        () -> game.makeMove(getNewMove(getNewPosition(6, 2), getNewPosition(4, 2), null)));
  ...
  @ParameterizedTest
  @EnumSource(
      value = ChessPiece.PieceType.class,
      names = {"QUEEN", "ROOK", "KNIGHT", "BISHOP"})
  ...
  public void promotionMoves(ChessPiece.PieceType promotionType) throws InvalidMoveException {
    ...
    // White promotion
    ChessMove whitePromotion =
        getNewMove(getNewPosition(7, 3), getNewPosition(8, 3), promotionType);
    game.makeMove(whitePromotion);

    Assertions.assertNull(
        game.getBoard().getPiece(whitePromotion.getStartPosition()),
    ...
    Assertions.assertEquals(
        promotionType,
        whiteEndPiece.getPieceType(),
        "Found piece at end position is not the correct piece type");
    Assertions.assertEquals(
        ChessGame.TeamColor.WHITE,
        whiteEndPiece.getTeamColor(),
        "Found piece at end position is the wrong team color");

    // Black take + promotion
    ChessMove blackPromotion =
        getNewMove(getNewPosition(2, 5), getNewPosition(1, 6), promotionType);
    game.makeMove(blackPromotion);

    Assertions.assertNull(
        game.getBoard().getPiece(blackPromotion.getStartPosition()),
        "After move, a piece is still present in the start position");
    ...
    Assertions.assertEquals(
        promotionType,
        blackEndPiece.getPieceType(),
        "Found piece at end position is not the correct piece type");
    Assertions.assertEquals(
        ChessGame.TeamColor.BLACK,
        blackEndPiece.getTeamColor(),
        "Found piece at end position is the wrong team color");
  }
  ...
  public class ValidMoveTests {
    ...
    public void moveIntoCheck() {
      ...
      var validMoves =
          loadMoves(rookPosition, new int[][] {{5, 7}, {5, 5}, {5, 4}, {5, 3}, {5, 2}});
    ...
    public void rookPinnedToKing() {
      ...
      Assertions.assertTrue(
          game.validMoves(position).isEmpty(),
    ...
    public void kingInDanger() {
      ...
      Assertions.assertTrue(
          game.validMoves(pawnPosition).isEmpty(),
          "ChessGame validMoves returned valid moves for a trapped piece");
      Assertions.assertTrue(
          game.validMoves(bishopPosition).isEmpty(),
          "ChessGame validMoves returned valid moves for a trapped piece");
      Assertions.assertTrue(
          game.validMoves(queenPosition).isEmpty(),
          "ChessGame validMoves returned valid moves for a trapped piece");
      Assertions.assertTrue(
          game.validMoves(knightPosition).isEmpty(),
          "ChessGame validMoves returned valid moves for a trapped piece");
      Assertions.assertTrue(
          game.validMoves(rookPosition).isEmpty(),
          "ChessGame validMoves returned valid moves for a trapped piece");
    }
  ...
  private void assertMoves(ChessGame game, Set<ChessMove> validMoves, ChessPosition position) {
    ...
    Assertions.assertEquals(
        validMoves, actualMoves, "ChessGame validMoves did not return the correct moves");
  }
}
